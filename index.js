...
//
// ### function WinstonSumoLogic (options)
// #### @options {Object} Options for this instance.
// Constructor function for the WinstonSumoLogic transport object responsible
// for persisting log messages and metadata to one or more files.
//
var WinstonSumoLogic = function (options) {
...
//
util.inherits(WinstonSumoLogic, Transport);

//
// Expose the name of this Transport on the prototype
//
WinstonSumoLogic.prototype.name = 'winstonSumoLogic';
...
//
WinstonSumoLogic.prototype.log = function (level, msg, meta, callback) {
  if (this.silent) {
  ...
  var output = this.formatOutput(new Date().toISOString(), level, msg, meta);
...
WinstonSumoLogic.prototype.formatOutput = function(d, level, msg, meta) {
  var output;
...
//
WinstonSumoLogic.prototype._write = function(data, callback) {
  if (this._isStreams2) {
...
//
WinstonSumoLogic.prototype.query = function (options, callback) {
...
//
WinstonSumoLogic.prototype.stream = function (options) {
  var file = path.join(this.dirname, this.filename),
      options = options || {},
      stream = new Stream;
...
//
WinstonSumoLogic.prototype.open = function (callback) {
  if (this.opening) {
    //
...
//
WinstonSumoLogic.prototype.close = function () {
  var self = this;
...
//
WinstonSumoLogic.prototype.flush = function () {
  var self = this;
...
//
WinstonSumoLogic.prototype._createStream = function () {
  var self = this;
  this.opening = true;
...
//
WinstonSumoLogic.prototype._getFile = function (inc) {
  var self = this,
...
//
WinstonSumoLogic.prototype._lazyDrain = function () {
  var self = this;
